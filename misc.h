...
#if __has_include("config_paths.h")
#include "config_paths.h" // pick up GIT/path macros when generated by Makefile
#endif
#endif

#ifndef GIT_REMOTE_URL
#define GIT_REMOTE_URL "unknown"
#endif
...
#define GIT_COMMIT_INDEX "unknown"
#endif
